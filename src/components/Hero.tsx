...
export const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.from(".hero-text-element", {
        y: 40,
        autoAlpha: 0, // autoAlpha é mais seguro que opacity
        duration: 1,
      ...
      .from(".hero-cta", {
        ...
        duration: 0.8,
        ease: "power3.out",
        clearProps: "opacity,transform,visibility" // Ensure hover states work cleanly after animation
      ...
      .fromTo(".hero-visual-col", 
        ...
        {
          y: 0,
          autoAlpha: 1, // Força visibilidade final
          duration: 1,
          ease: "power3.out"
        }, "<0.2") 
      .from(".hero-badge", {
  ...
  return (
    // Padding restaurado para valores normais (pb-32).
    // O VerticalScroll entra naturalmente após esta seção.
    <section ref={containerRef} className="relative min-h-screen flex flex-col justify-center pt-28 md:pt-32 pb-32 bg-transparent z-20">
      ...
      <div className="container mx-auto px-6 z-10">
        ...
        <div className="flex flex-col items-center gap-2 md:gap-6">
          ...
          <div className="w-full max-w-6xl text-center relative z-20 mx-auto">
            ...
            <div className="hero-text-element inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/80 border border-blue-200 backdrop-blur-md mb-4 md:mb-6 mx-auto shadow-sm ring-1 ring-blue-50">
              ...
              <span className="text-xs font-bold text-blue-700 tracking-wide uppercase">Psicologia Baseada em Evidências</span>
            </div>
            ...
            <h1 className="hero-text-element text-3xl md:text-5xl lg:text-7xl font-bold tracking-tighter text-slate-900 mb-4 md:mb-6 leading-[1.1] font-serif drop-shadow-sm">
              O Silêncio que você&nbsp;implora <br className="hidden md:block" />
            ...
            <p className="hero-text-element text-base md:text-xl text-slate-700 mb-6 md:mb-6 leading-relaxed font-normal max-w-2xl mx-auto text-shadow-sm">
              Você já tentou "respirar fundo", terapias infinitas e comprimidos, mas o aperto no peito continua? <strong>Sua mente não está quebrada, ela está hipervigilante.</strong> Aprenda a desligar o alerta de perigo em 21 dias.
            </p>
          ...
          <div className="hero-visual-col w-[85%] md:w-full max-w-5xl relative perspective-1000 mx-auto mt-0 md:mt-4">
             ...
             <div className="hero-badge float-y absolute -top-8 left-1/2 -translate-x-[60%] md:translate-x-0 md:-top-10 md:-right-8 p-3 md:p-4 bg-white/90 backdrop-blur-xl border border-white/60 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] flex items-center gap-3 z-20 max-w-[160px] md:max-w-[240px]">
                <div className="w-8 h-8 md:w-12 md:h-12 rounded-full bg-slate-200 overflow-hidden shrink-0 border-2 border-white">
                   <img src="https://metodocms.com/wp-content/uploads/2025/07/hero-bottom.webp" alt="Dra Quiteria" className="w-full h-full object-cover object-top" />
                </div>
                <div>
                   <p className="text-slate-900 font-bold text-xs md:text-sm leading-tight">Dra. Quitéria Gouveia</p>
                   <p className="text-blue-600 text-[10px] md:text-xs font-medium">Psicoterapeuta Especialista</p>
                </div>
             </div>
