...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-24 relative z-10 overflow-visible">
      {/*
        Container principal: flex-row no desktop.
        A imagem fica sticky dentro da seção usando `sticky top-24`.
        O texto rola. Quando a seção acaba, a imagem sai junto.
      */}
          ...
          <div className="lg:w-[42%] lg:sticky lg:top-24 self-start about-image transition-opacity duration-700">
            <div className="relative w-full max-w-lg mx-auto lg:mx-0">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl flex flex-col items-center justify-center border border-slate-100 animate-bounce duration-[3000ms] z-30">
                ...
                <div className="w-8 h-[1px] bg-blue-200 mt-2" />
              </div>
            </div>
          </div>

          {/* ── COLUNA DIREITA: TEXTO QUE ROLA ── */}
          <div className="flex-1 space-y-8 lg:py-4">
