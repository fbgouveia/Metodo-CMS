...
export const LegalModal: React.FC<LegalModalProps> = ({ type, onClose }) => {
          ...
          <>
            ...
            <div className="space-y-6 text-slate-600">
              ...
              <div className="grid gap-4">
                <a href="https://api.whatsapp.com/send?phone=5511956185501&text=Ola!%2C%20Gostaria%20de%20saber%20mais%20sobre%20as%20consultas" target="_blank" rel="noreferrer" className="flex items-center gap-4 p-4 rounded-xl border border-green-200 bg-green-50 hover:bg-green-100 transition-colors group">
                ...
                <a href="mailto:suporte@metodocms.com" className="flex items-center gap-4 p-4 rounded-xl border border-blue-200 bg-blue-50 hover:bg-blue-100 transition-colors group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">suporte@metodocms.com</p>
                  </div>
                </a>
              </div>
            </div>
  ...
  return (
    <div className="legal-overlay fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
      <div className="absolute inset-0" onClick={onClose}></div>
      <div className="legal-modal-content relative w-full max-w-2xl max-h-[85vh] overflow-y-auto bg-white rounded-3xl shadow-2xl flex flex-col">
        <button 
          onClick={onClose}
