...
export const HorizontalScroll: React.FC = () => {
  ...
  return (
    <section id="method" className="relative bg-slate-50 py-24 overflow-hidden z-20">
      ...
      {/* Container de Scroll Horizontal (Nativo e Seguro) */}
      <div 
        ref={scrollContainer}
      ...
      >
          ...
          {/* Cards dos Passos */}
          {steps.map((step) => (
            <div key={step.id} className="relative min-w-[320px] md:min-w-[400px] h-[500px] rounded-[2.5rem] overflow-hidden shadow-xl group snap-center border border-white">
