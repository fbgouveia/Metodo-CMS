    ...
    <section className="py-24 relative z-10 bg-transparent">
      <div ref={containerRef} className="container mx-auto px-6">
        ...
        <div className="text-center mb-20">
            <div className="inline-block px-4 py-1.5 rounded-full bg-white/40 border border-white/50 backdrop-blur-md mb-6 shadow-sm">
               <span className="text-xs font-bold text-slate-600 tracking-wider uppercase">Comparativo Técnico</span>
            </div>
