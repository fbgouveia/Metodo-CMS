...
export const ProgramDetails: React.FC = () => {
  ...
  return (
    <section className="py-24 relative z-10 bg-white/30 backdrop-blur-sm">
      <div ref={containerRef} className="container mx-auto px-6">
        <div className="text-center mb-20">
            <div className="inline-block px-4 py-1.5 rounded-full bg-slate-100 border border-slate-200 mb-6">
               <span className="text-xs font-bold text-slate-500 tracking-wider uppercase">Comparativo Técnico</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-serif text-slate-900 mb-6 tracking-tight">O Fim da "Conversa Fiada"</h2>
            <p className="text-slate-600 font-light text-lg max-w-2xl mx-auto">Por que o Método CMS funciona onde remédios e terapias tradicionais falharam.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch mb-16 max-w-6xl mx-auto">
            {/* O Curso - Estilo Editorial Clean */}
            <div className="program-box relative bg-white/60 rounded-[2rem] p-10 md:p-12 border border-white shadow-xl flex flex-col overflow-hidden group hover:border-blue-200 transition-colors duration-500">
                ...
                <div className="relative z-10">
                    ...
                    <ul className="space-y-10">
                        ...
                        <li className="relative pl-0">
                            <span className="text-5xl font-serif text-purple-200 absolute -left-4 -top-6 opacity-50 select-none">II.</span>
                            <h4 className="font-serif text-xl text-slate-900 mb-2 relative z-10 font-medium">Domínio dos Pensamentos</h4>
                            <p className="text-sm text-slate-600 leading-relaxed font-light relative z-10">Sabe aquela voz que diz que tudo vai dar errado? Você vai aprender a silenciá-la com lógica e técnica, não com "força de vontade".</p>
                        </li>
                        <li className="relative pl-0">
                            ...
                            <p className="text-sm text-slate-600 leading-relaxed font-light relative z-10">Sua ansiedade afeta quem você ama. Aqui você aprende a proteger seu casamento e seus filhos do seu caos emocional.</p>
                        </li>
                    </ul>
                </div>
            </div>

            {/* A Mentoria - Estilo Editorial Dark/Premium */}
