      ...
      <div ref={containerRef} className="container mx-auto px-6 max-w-3xl">
        ...
        <div className="space-y-3">
          {faqs.map((faq, index) => (
            <div 
              key={index} 
              className={`faq-item opacity-0 rounded-2xl overflow-hidden transition-all duration-300 ${
                openIndex === index 
            ...
            >
              ...
              >
                ...
                <div className={`shrink-0 w-6 h-6 rounded-full flex items-center justify-center transition-colors ${
                    openIndex === index ? 'bg-blue-100 text-blue-600' : 'bg-slate-200 text-slate-500 group-hover:bg-blue-100 group-hover:text-blue-600'
                }`}>
