    ...
    >
      ...
      {mobileMenuOpen && (
        <div className="absolute top-full left-0 w-full bg-white/95 backdrop-blur-xl border-b border-slate-200 p-6 flex flex-col gap-6 md:hidden animate-in slide-in-from-top-5 min-h-[50vh] shadow-xl">
          ...
          <a href="https://api.whatsapp.com/send?phone=5511956185501&text=Ola!%2C%20Gostaria%20de%20saber%20mais%20sobre%20as%20consultas" className="text-xl font-medium text-green-600 flex items-center gap-2">
