  ...
  return (
    <section className="py-20 overflow-hidden bg-slate-900 relative z-10 border-y border-slate-800">
      <div className="container mx-auto px-6 text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-serif text-white mb-2">Eles achavam que não tinha jeito.</h2>
        <p className="text-slate-400">Pessoas reais que saíram do fundo do poço e hoje vivem em Modo Silencioso.</p>
      </div>
